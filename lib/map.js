 ...
 *
 * @param {Array<import('./utils/step.js').ChainifyStepConfig>} steps - The sequence of step configurations to apply.
 * @returns {ChainifyMapHandler} A chainable handler function that processes input and returns the transformed result.
 */
