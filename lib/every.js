 ...
 *   each intermediate result. Returns true to continue; false to abort and return null.
 * @returns {RechainifyEveryHandler} A chainable handler function that accumulates steps and
 *   processes input when invoked.
 */
