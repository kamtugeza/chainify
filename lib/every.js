 ...
 * @param {(input: any) => boolean} [predicate=ChainifyPredicate.isNonNull] - Function applied to each
 *   intermediate result. Returns true to continue; false to abort and return null.
 * @returns {ChainifyEveryHandler} A chainable handler function that accumulates steps and processes
 *   input when invoked.
 */
